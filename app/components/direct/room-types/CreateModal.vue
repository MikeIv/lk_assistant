...
import type { RoomTypeCreatePayload, RoomTypeCreateResult } from '#shared/types/roomTypes'

const props = defineProps<{
  submitFn: (payload: RoomTypeCreatePayload) => Promise<RoomTypeCreateResult>
}>()
  ...
  <Teleport to="body">
    <div v-if="open" :class="$style.overlay" @mousedown.self="close">
      <form
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="room-types-create-title"
        @submit.prevent="onSubmit"
      >
        <div :class="$style.header">
          <h3 id="room-types-create-title" :class="$style.title">Создание типа помещения</h3>
