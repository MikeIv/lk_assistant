...
function openEdit(item: Applicant) {
...
<template>
  <div :class="$style.root">
    ...
    <DirectApplicantsCreateModal
      v-model:open="isCreateOpen"
      :categories="categories"
      :legal-entities="legalEntities"
      :submit-fn="createApplicant"
    />

    <DirectApplicantsEditModal
      v-model:open="isEditOpen"
      :applicant="selectedApplicant"
      :categories="categories"
      :legal-entities="legalEntities"
      :submit-fn="updateApplicant"
      :delete-fn="deleteApplicant"
    />
  </div>
</template>
