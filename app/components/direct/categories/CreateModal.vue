...
import type { CategoryCreatePayload, CategoryCreateResult } from '#shared/types/categories'

const props = defineProps<{
  submitFn: (payload: CategoryCreatePayload) => Promise<CategoryCreateResult>
}>()
  ...
  <Teleport to="body">
    <div v-if="open" :class="$style.overlay" @mousedown.self="close">
      <form
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="categories-create-title"
        @submit.prevent="onSubmit"
      >
        <div :class="$style.header">
          <h3 id="categories-create-title" :class="$style.title">Создание категории</h3>
